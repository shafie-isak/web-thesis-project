...
const MockExams = () => {
  ...
  const loadSubjects = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/subjects`, { headers });
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await axios.post(`${process.env.REACT_APP_API_URL}/api/mockexams`, {
        subject_id,
  ...
  const handleEdit = async () => {
    ...
    setUpdating(true);
    try {
      await axios.put(`${process.env.REACT_APP_API_URL}/api/mockexams/${editData._id}`, editData, { headers });
  ...
  const handleDelete = async (id) => {
    ...
    setDeletingId(id);
    try {
      await axios.delete(`${process.env.REACT_APP_API_URL}/api/mockexams/${id}`, { headers });
